#!/usr/bin/env python3
"""Check domain availability — Batch 4 (50 names)."""
...
NAMES = [
    "muvr", "nexfit", "trovo", "rallo", "venno",
    "krevv", "wello", "lynkup", "boonr", "mixio",
    "zenduo", "gravio", "yondo", "strydo", "travik",
    "voxio", "blaziq", "exofit", "moviq", "sporto",
    "kynekt", "plexo", "kinemo", "ralliq", "paqfit",
    "crewvue", "fitvue", "trailvu", "nexrun", "togfit",
    "zenfit", "nexgo", "blazfit", "nexmeet", "meetrun",
    "outmeet", "runspot", "crewspot", "fitvu", "crewpuls",
    "peakvue", "nexsquad", "togvibe", "sportpact", "outdoorly",
    "squadvu", "fitventr", "trailpals", "nexfolk", "crewpath",
]
