#!/usr/bin/env python3
"""Check domain availability for yoga app brand name candidates (.com, .ca, .app)."""
...
NAMES = [
    # Namaste-based
    "namadate", "namate", "namduo", "namiq", "namio",
    "namvibe", "nambloom", "namabond", "namameet", "namalink",
    # Zen-based
    "zendate", "zenmate", "zenduo", "zenpair", "zengo",
    "zeniq", "zenio", "zenvibe", "zenbloom", "zenbond",
    "zenmeet", "zenlink",
    # Flow-based
    "flowdate", "flowmate", "flowduo", "flowpair", "flowgo",
    "flowiq", "flowio", "flowvibe", "flowbloom", "flowbond",
    "flowmeet", "flowlink",
    # Yoga/Yogi-based
    "yogdate", "yogidate", "yogiduo", "yogipair", "yogigo",
    "yogiq", "yogio", "yogvibe", "yogbloom", "yogabond",
    "yogameet", "yogilink",
    # Sanskrit-inspired
    "pranaio", "praniq", "asanio", "chakrio",
]
...
def main():
    print(f"\n{BOLD}🧘 Domain Availability Checker — Yoga App Candidates{RESET}")
