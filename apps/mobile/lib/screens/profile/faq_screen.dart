...
class FaqScreen extends StatelessWidget {
  ...
  static const _faqs = <_FaqItem>[
    _FaqItem(
      question: 'C\'est quoi Run Date?',
      answer: 'Run Date c\'est une app sociale sportive pour bouger en groupe '
    ...
    _FaqItem(
      ...
      answer: 'Dans le chat de groupe, appuie sur le menu (⋯) en haut à '
          ...
          'à contact@rundate.app. On prend chaque signalement au sérieux.',
    ),
  ];
