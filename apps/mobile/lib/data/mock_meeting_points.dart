...
/// Mock meeting points for Run Date group activities in Montreal.
final List<MeetingPoint> mockMeetingPoints = List<MeetingPoint>.unmodifiable([
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp1/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp2/640/400',
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp3/640/400',
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp4/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp5/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp6/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp7/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp8/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp9/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp10/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp11/640/400',
    mapsUrl:
  ...
  const MeetingPoint(
    ...
    photoUrl: 'https://picsum.photos/seed/rundate-mp12/640/400',
    mapsUrl:
